...
use unilayer::consensus::{encode, Decodable};
use unilayer::p2p::{self, address, message, message_network};
use unilayer::secp256k1::rand::Rng;

fn main() {
    // This example establishes a connection to a UniLayer node, sends the initial
    ...
    let first_message =
        message::RawNetworkMessage::new(unilayer::Network::UniLayer.magic(), version_message);
            ...
            match reply.payload() {
                message::NetworkMessage::Version(_) => {
                    ...
                    let second_message = message::RawNetworkMessage::new(
                        unilayer::Network::UniLayer.magic(),
