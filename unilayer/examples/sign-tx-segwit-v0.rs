...
use unilayer::secp256k1::{rand, Message, Secp256k1, SecretKey, Signing};
use unilayer::sighash::{EcdsaSighashType, SighashCache};
use unilayer::{
...
fn main() {
    ...
    let signature = unilayer::ecdsa::Signature { signature, sighash_type };
...
fn senders_keys<C: Signing>(secp: &Secp256k1<C>) -> (SecretKey, WPubkeyHash) {
    ...
    let pk = unilayer::PublicKey::new(sk.public_key(secp));
