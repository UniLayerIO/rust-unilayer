...
/// UniLayer block version number.
///
/// Originally used as a protocol version, but repurposed for soft-fork signaling.
///
/// The inner value is a signed integer in UniLayer Core for historical reasons, if version bits is
...
impl Version {
    ...
    ///
    /// This is the data type used in consensus code in UniLayer Core.
    #[inline]
