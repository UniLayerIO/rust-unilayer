...
impl FeeRate {
    ...
    ///
    /// The value matches the default Bitcoin/UniLayer Core policy at the time of library release.
    ...
    ///
    /// ```
    /// # use unilayer::{absolute, transaction, FeeRate, Transaction};
    /// # // Dummy transaction.
...
crate::parse::impl_parse_str_from_int_infallible!(FeeRate, u128, from_sat_per_kwu);
