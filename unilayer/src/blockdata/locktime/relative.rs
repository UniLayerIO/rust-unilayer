...
///
/// Used for sequence numbers (`nSequence` in Bitcoin/UniLayer Core and [`crate::TxIn::sequence`]
...
impl LockTime {
    ...
    ///
    /// ```rust
    /// # use unilayer::relative::LockTime;
    ///
    ...
    /// Constructs a `LockTime` from the sequence number of a Bitcoin/UniLayer input.
    ///
