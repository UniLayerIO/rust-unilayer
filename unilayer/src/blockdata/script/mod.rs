...
//!
//! <details>
//! <summary>What is Bitcoin/UniLayer script</summary>
//!
//! Scripts define Bitcoin's and UniLayer's digital signature scheme: a signature is formed
...
//! the script leaves `TRUE` on the stack after being evaluated. Bitcoin's and UniLayer's
...
//! and forcing them to be larger would waste memory and, in case of Bitcoin or UniLayer script, even some
...
hashes::hash_newtype! {
    /// A hash of UniLayer Script bytecode.
    pub struct ScriptHash(hash160::Hash);
    /// SegWit version of a UniLayer Script bytecode hash.
