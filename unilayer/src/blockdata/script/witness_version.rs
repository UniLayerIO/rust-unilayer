...
impl WitnessVersion {
    ...
    /// version in unilayer script. Thus, there is no function to directly convert witness version
    /// into a byte since the conversion requires context (unilayer script or just a version number).
