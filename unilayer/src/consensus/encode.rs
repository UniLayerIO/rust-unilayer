...
//! Bitcoin/UniLayer consensus-encodable types.
//!
...
/// Extensions of `Write` to encode data as per Bitcoin/UniLayer consensus.
...
/// Extensions of `Read` to decode data as per UniLayer consensus.
