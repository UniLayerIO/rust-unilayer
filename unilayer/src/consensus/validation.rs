...
//    unusual versioning used in `bitcoinconsensus` to users of `rust-unilayer`.
// 2. We want to implement `std::error::Error` if the "std" feature is enabled in `rust-unilayer` but
