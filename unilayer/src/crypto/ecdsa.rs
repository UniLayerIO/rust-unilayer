...
//! ECDSA Bitcoin/UniLayer signatures.
//!
//! This module provides ECDSA signatures used by Bitcoin/UniLayer that can be roundtrip (de)serialized.
...
impl Signature {
    /// Constructs an ECDSA Bitcoin/UniLayer signature for [`EcdsaSighashType::All`].
