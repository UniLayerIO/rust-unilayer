...
//! Bitcoin/UniLayer keys.
//!
//! This module provides keys used in Bitcoin/UniLayer that can be roundtrip
//! (de)serialized.
...
/// A Bitcoin/UniLayer ECDSA public key
...
impl PublicKey {
    ...
    /// Returns unilayer 160-bit hash of the public key
    pub fn pubkey_hash(&self) -> PubkeyHash { self.with_serialized(PubkeyHash::hash) }

    /// Returns unilayer 160-bit hash of the public key for witness program
    ...
    ///
    /// This method of sorting is in line with UniLayer Core's implementation of
    ...
    ///     // after compressed keys in UniLayer Core using `sortedmulti()`
    ///     pk("045d753414fa292ea5b8f56e39cfb6a0287b2546231a5cb05c4b14ab4b463d171f5128148985b23eccb1e2905374873b1f09b9487f47afa6b1f2b0083ac8b4f7e8"),
    ///     pk("04c4b0bbb339aa236bff38dbe6a451e111972a7909a126bc424013cba2ec33bc3816753d96001fd7cba3ce5372f5c9a0d63708183033538d07b1e532fc43aaacfa"),
    ///     pk("04c4b0bbb339aa236bff38dbe6a451e111972a7909a126bc424013cba2ec33bc38e98ac269ffe028345c31ac8d0a365f29c8f7e7cfccac72f84e1acd02bc554f35"),
    /// ];
...
/// An always-compressed Bitcoin/UniLayer ECDSA public key
#[derive(Debug, Copy, Clone, PartialEq, Eq, PartialOrd, Ord, Hash)]
...
/// A Bitcoin/UniLayer ECDSA private key
