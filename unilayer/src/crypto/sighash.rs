...
impl EcdsaSighashType {
    ...
    pub fn from_consensus(n: u32) -> EcdsaSighashType {
        ...
        // In UniLayer Core, the SignatureHash function will mask the (int32) value with
...
impl<R: BorrowMut<Transaction>> SighashCache<R> {
    ...
    ///
    /// [`segwit v0`]: <https://github.com/UniLayerIO/rust-unilayer/blob/master/bitcoin/examples/sign-tx-segwit-v0.rs>
    /// [`taproot`]: <https://github.com/UniLayerIO/rust-unilayer/blob/master/bitcoin/examples/sign-tx-taproot.rs>
...
impl<E> EncodeSigningDataResult<E> {
    ...
    ///
    /// ```rust
    /// # use unilayer::consensus::deserialize;
    /// # use unilayer::hashes::{Hash, hex::FromHex};
    /// # use unilayer::sighash::{LegacySighash, SighashCache};
    /// # use unilayer::Transaction;
    /// # let mut writer = LegacySighash::engine();
    /// # let input_index = 0;
    /// # let script_pubkey = unilayer::ScriptBuf::new();
