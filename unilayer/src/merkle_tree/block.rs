...
//!
//! ```rust
//! use unilayer::hash_types::Txid;
//! use unilayer::hex::FromHex;
//! use unilayer::{Block, MerkleBlock};
//!
//! // Get the proof from a ulrd by running in the terminal:
//! // $ TXID="5a4ebf66822b0b2d56bd9dc64ece0bc38ee7844a23ff1d7320a88c5fdb2ad3e2"
//! // $ ulr-cli gettxoutproof [\"$TXID\"]
...
//! let mb: MerkleBlock = unilayer::consensus::deserialize(&mb_bytes).unwrap();
//!
...
impl MerkleBlock {
    ...
    /// let block: Block = unilayer::consensus::deserialize(&block_bytes).unwrap();
    ///
...
impl PartialMerkleTree {
    ...
    /// use unilayer::hash_types::Txid;
    /// use unilayer::hex::FromHex;
    /// use unilayer::merkle_tree::{MerkleBlock, PartialMerkleTree};
    ///
    /// // Block 80000
    /// let txids: Vec<Txid> = [
...
impl Decodable for PartialMerkleTree {
    fn consensus_decode_from_finite_reader<R: BufRead + ?Sized>(
        ...
        let nb_bytes_for_bits = encode::CompactSize::consensus_decode(r)?.0 as usize;
