...
//! Bitcoin or UniLayer Network. As such they must not be relied upon as if they were consensus rules.
//!
//! These values were taken from ulrd v1.0.1 (194b9b8792d9b0798fdb570b79fa51f1d1f5ebaf).
//!
...
pub const DUST_RELAY_TX_FEE: u128 = 60_000_000_000; // 60 * CENT (aULR * 1e9)

/// Minimum feerate, in sats per virtual kilobyte, for a transaction to be relayed by most nodes on
/// the network.
pub const DEFAULT_MIN_RELAY_TX_FEE: u128 = 6_000_000_000; // 6 * CENT (aULR * 1e9)
