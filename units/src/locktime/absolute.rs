...
//! Provides type `Height` and `Time` types used by the `rust-unilayer` `absolute::LockTime` type.
...
///
/// UniLayer is able to safely use this value because a block height greater than 1,500,000,000 would
